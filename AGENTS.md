...
uv run manage.py test api.tests.test_posts

# Run single test class
uv run manage.py test api.tests.test_posts.TestPost

# Run single test method
uv run manage.py test api.tests.test_posts.TestPost.test_post_embedding_generation

# Run tests with verbose output
uv run manage.py test --verbosity 2

# Run tests with specific test runner (Django default)
uv run manage.py test api.tests.test_posts --testrunner django.test.runner.DiscoverRunner
```
